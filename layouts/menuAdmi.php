<section id="menu_horizontal" role="tabpanel" aria-labelledby="list-home-list">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
            <a class="nav-link collapsed" href="#EMPLEADOS" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="?mod=empleados">Personas</a>
                    <a class="collapse-item" href="?mod=cargos">Cargos</a>
                    <a class="collapse-item" href="?mod=turnos">Turnos</a>
                </div>
            </div>
            </li>
            <!-- Gestion de Clientes-->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePP"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fa fa-bullhorn"></i>
                    <span>Pts y Promociones</span>
                </a>
                <div id="collapsePP" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Componentes:</h6>
                        <a class="collapse-item" href="?mod=puntosAdm">Puntos</a>
                        <a class="collapse-item" href="?mod=prom">Promociones</a>
                    </div>
                </div>
            </li>
