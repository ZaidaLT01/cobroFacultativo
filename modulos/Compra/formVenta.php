...
<?php
	...
	$consulta1="SELECT id_cliente, razon_social FROM cliente";
					...
					<div class="panel-body">
                        <div class="row">
                        	<div class="col-lg-12">
                        		...
                        		<hr>
								<form role="form" method="post" action="../modelo/grabarVenta.php" name="formulario" id="formulario" enctype="multipart/form-data">
		                            <div class="col-lg-3">
		                            </div>
                            	<div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Cliente:</label>
                                        <?php //MOSTRAR EN EL SELECT	
											echo "<select id='id_cliente' name='id_cliente' class='form-control'> ";
											while ($registro1=mysqli_fetch_array($resultado1))
											{
												echo "<option value='".$registro1['id_cliente']."'> ".$registro1['razon_social']." </option>";
											}
											echo "</select>";
										?>
                                    </div>
