<!--Bienvenida-->
<section id="inicio"  data-preset='{"title":"Content block 1","category":"content","id":"content-block-1"}'>
  <div class="container">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h3 class="section-subheading text-muted">Aqui Puedes Consultar cualquier duda sobre nuestros servicios.</h3>
      </div>
    </div>

    <div class="row justify-content-center grid-group-lg">

      <div class="col-md-8 col-lg-4">
        <!-- Icon Box Type 5-->
        <div class="team-member">
          <img class="mx-auto rounded-circle" src="img/user.jpg" alt="">
          <h4>Reyna Tito</h4>
          <p class="text-muted">Director - Administrador<br>Tel/cel: 77297685</p>
          <ul class="list-inline social-buttons">
            ...
            <li class="list-inline-item">
              <a href="https://www.facebook.com/reyna.tito.luque?locale=es_LA">
                <i class="fa fa-facebook"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="https://wa.link/kbvbcb">
        ...
        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
          <div class="row align-items-stretch mb-5">
            ...
            <div class="col-md-6">
              ...
              <!-- Name input-->
                <input class="form-control" id="name" type="text" placeholder="Tu nomre *" data-sb-validations="required" />
              ...
              <div class="form-group mb-md-0">
                ...
                <div class="invalid-feedback" data-sb-feedback="phone:required">Un Numero de celular es requerido. </div>
              </div>
            </div>
          ...
          <div class="d-none" id="submitSuccessMessage">
              <div class="text-center text-white mb-3">
                  <div class="fw-bolder">Subida de Formulario Existoso!</div>
          ...
          <div class="d-none" id="submitErrorMessage"><div class="text-center text-danger mb-3">Error en enviar el mensaje!</div></div>
          <!-- Submit Button-->
